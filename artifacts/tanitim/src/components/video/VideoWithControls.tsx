  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'Sahneyi tekrarla: açık' : 'Sahneyi tekrarla: kapalı'}
        aria-label={locked ? 'Sahneyi tekrarla: açık' : 'Sahneyi tekrarla: kapalı'}
        aria-pressed={locked}
      >
      ...
      <button
        ...
        title={collapsed ? 'Kontrolleri göster' : 'Kontrolleri gizle'}
        aria-label={collapsed ? 'Kontrolleri göster' : 'Kontrolleri gizle'}
