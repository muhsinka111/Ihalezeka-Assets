  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, #a5b8f8 0%, transparent 70%)",
        }}
      />
      <div
      ...
      <div
        ...
        style={{
          boxShadow:
            "0 24px 64px -12px rgba(20,33,61,0.18), 0 8px 24px rgba(0,0,0,0.06)",
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(155deg, #14213D 0%, #2D5BFF 100%)",
          }}
        >
          {/* Dot pattern */}
          <div
          ...
          <div className="relative">
            ...
            <p className="text-blue-200/60 text-[11px]">
              "Artık hiçbir ihaleyi kaçırmıyoruz"
            </p>
          </div>
        </div>
